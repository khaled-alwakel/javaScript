...
//      output = 'NEW OUTPUT!';
//
//      const str = `Oh, and you're a millenial, ${firstName} 👊️`;
//      console.log(str);
//
//      function add(a, b) {
//        return a + b;
...
//f(); // undefined coz it is a regular function
...
//
//  greet: () => {
//    console.log(this); // global object : window, this is arrow function refer to the outter object which is window
